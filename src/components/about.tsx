...
const About = () => {
    return (
      <div className="max-w-[1200px] mx-auto pt-10" id="about">
  
          <h1 className="text-white text-6xl w-[320px] mx-auto font-semibold p-4 mb-10">About <span className="text-orange-400">Me</span>
          </h1>
          ...
          <div className="px-6 md:p-0 grid md:grid-cols-8 gap-6 place-items-center">
              ...
              <div className="flex flex-row p-6">
                  ...
                  <div className="flex flex-col mt-4">
                      ...
                      <p className="text-lg text-white/70 mt-2">Pursuing a certification in Cloud Applied Generative AI Engineering and I am focusing on technologies like React, Next.js, and Tailwind CSS.</p>
                  </div>
              </div>
              </div>
              ...
              <div className="flex flex-row p-6">
                  ...
                  <div className="flex flex-col mt-4">
                      ...
                      <p className="text-lg text-white/70 mt-2">As a Frontened Web Developer, I specialize in React.js, Next.js, and Tailwind CSS. My expertise extends to creating responsive, user-friendly interfaces.</p>
                  </div>
              </div>
              </div>
