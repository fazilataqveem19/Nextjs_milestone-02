...
const Portfolio = () => {
  return (
    <div className="text-white bg-gradient-to-b from-black to-[#381a5f] py-18 mt-52 scroll-mt-20" id="portfolio">
        ...
        {projects.map((project, index) => (
          ...
          >
            <div className="space-y-6 md:space-y-4 max-w-[550px] px-4 md:px-0">
              ...
              <p className={`text-lg sm:text-xl text-orange-400 font-semibold ${index === 0 || index === 2 ? 'mt-4' : ''} ${index % 2 === 0 ? 'mb-4' : ''} hidden sm:block`}
              >
                {project.devstack}
                </p>
